// https://raw.githubusercontent.com/observablehq/framework/main/src/client/stdlib/xlsx.js @ Jun 13
...
export class Workbook {
  ...
  static async load(buffer) {
    ...
    await workbook.xlsx.readFile(buffer); // DN load changed to readFile
